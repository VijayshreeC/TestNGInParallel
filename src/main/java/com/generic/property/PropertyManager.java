...
public class PropertyManager {
    ...
    private static final String APPLICATIONPROPERTIESPATH = "/src/main/java/com/globomantics/test/config/";
    		//"/src/test/resources/com/test/properties/";
    ...
    public static Properties loadApplicationPropertyFile() {
        try {
            PROPERTY.load(new FileInputStream(System.getProperty("user.dir")
                    + APPLICATIONPROPERTIESPATH + "config.properties"));
